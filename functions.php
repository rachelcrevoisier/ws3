...
if (    $query->is_home() // si page d'accueil
        ...
        && ! is_admin() ) {// non tab de bord
  $query->set( 'category_name', 'note-wp' );// filtre des articles catgorie note-wp
